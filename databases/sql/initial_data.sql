CREATE DATABASE  IF NOT EXISTS `pdf_me` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `pdf_me`;
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `key_id` FOREIGN KEY (`key_id`) REFERENCES `private_keys` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-06-09 16:12:01
